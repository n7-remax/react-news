...
class News extends Component {
    ...
    render() {
        ...
        const newsList = this.state.articles.slice(this.state.startIndex, this.state.endIndex).map((news, i) => {
            return (
        ...
        return (
            <div className="News">
                ...
                <Pagination count={totalPages} page={this.state.currentPage} onChange={this.handlePageChange} showFirstButton showLastButton size="large" />
                </div>
            </div>
        );
    }
